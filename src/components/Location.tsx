    ...
    <section className="bg-white rounded-xl shadow-sm border border-[#e5e1dc] overflow-hidden mb-8">
      <div className="p-6 md:p-8">
        ...
        <a
          ...
          className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-primary hover:bg-primary-dark text-white font-bold h-12 px-6 transition-colors shadow-sm mb-6"
        >
      ...
      >
        <div className="relative h-[240px] w-full bg-gray-100">
          <div
            className="absolute inset-0 bg-cover bg-center grayscale opacity-80 hover:grayscale-0 transition-all duration-500"
            style={{
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <div className="bg-white/90 p-3 rounded-full shadow-lg">
              <span className="material-symbols-outlined text-red-500 text-3xl">push_pin</span>
            </div>
          </div>
        </div>
      </a>
