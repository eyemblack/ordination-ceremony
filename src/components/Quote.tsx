  ...
  return (
    <section className="flex flex-col items-center py-12 px-6 text-center">
      ...
      <p className="text-text-main text-lg md:text-xl font-normal leading-relaxed italic relative font-thai">
        &quot;ขอเรียนเชิญร่วมอนุโมทนาในงานอุปสมบทครั้งนี้โดยพร้อมเพียงกัน กรรมใดที่ผู้อุปสมบทได้ล่วงเกินท่านด้วย กายกรรม วจีกรรม มโนกรรม ขอได้โปรดอโหสิกรรม ให้แก่ผู้อุปสมบทด้วยเถิด&quot;
      </p>
